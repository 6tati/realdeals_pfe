    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center px-6 py-16">
            <div className="w-full max-w-sm">
                <h2 className="text-3xl font-bold uppercase tracking-tight mb-2 text-center">Login</h2>
                <p className="text-neutral-500 text-sm mb-10 text-center">Welcome back.</p>
                ...
                <p className="text-center text-sm text-neutral-500 mt-8">
                    ...
                    <Link to="/register" className="text-black underline underline-offset-4 hover:text-neutral-600">
                        Register
                    </Link>
                </p>
            </div>
